...
df = spark.read.parquet(path_silver + file_consulta_cand).select("SQ_CANDIDATO", "NR_CANDIDATO", "NM_CANDIDATO", "NM_URNA_CANDIDATO", "NM_SOCIAL_CANDIDATO", "NR_CPF_CANDIDATO", "NM_EMAIL", "NR_TITULO_ELEITORAL_CANDIDATO", "CD_GENERO", "CD_GRAU_INSTRUCAO", "CD_ESTADO_CIVIL", "CD_COR_RACA", "CD_OCUPACAO", "CD_NACIONALIDADE").distinct()
df.display()
df.printSchema()
